...
In academic year 17/18 following the delivery of the security case project a poll was carried out to identify the effectiveness of the laboratory configurations. 

Table~\ref{tab:Useful}, is the results on how useful the \texttt{HILV} honeypot was for the students within the practical research compoent of the module. The results show that all of the students found the honeypot useful. This result was not outside of what was expected as it is usual for students to prefer to have access to physical equipment. 
...
\begin{table}[ht]
  ...
  \begin{tabular}{|l|c|}
  \hline
%  \multicolumn{2}{|l|}{\textbf{Q1. How useful was the honeypot in your studies?}}\\ \hline
...
Table~\ref{tab:Setup}, is the results on how easy it was to configure the \texttt{HILV} honeypot to a base configuration and then to adapt it to an individual groups requirements. None of the students found the device hard to work with in terms of creating the base operating system images on the servers. Each group of students worked on a different project requiring additional configuration from the base images. 

The main reasons for this ease of use where due to:
\begin{itemize}
...
Table~\ref{tab:UsedBefore} shows that the majority of the students have not used a \texttt{HILV} honeypot before their undergraduate studies, in contrast, Table~\ref{tab:UseAgain} shows that the majority of the students who used the \texttt{HILV} honeypot would use the platform again for further studies if the opportunity arises. The \texttt{HILV} honeypots have been available for severel years now and students who move to the final year of the cyber security undergraduate programme tend to carry out research based projects. Usually they involve the basic unchanged \texttt{HILV} honeypot but some projects add additional components to the honeypot such as firewalls (pfSense~\cite{} or ipFire~\cite{}) or wireless access points for the analysis of phone or tablet based application attacks.  
...
% \begin{figure}[ht]
%   \begin{center}
%     \includegraphics[scale=0.29]{Images/HPUseful.eps}
%   \caption{Useful?\label{fig:HPUseful}}
%   \end{center}
% \end{figure}

% \begin{figure}[ht]
%   \begin{center}
%     \includegraphics[scale=0.29]{Images/HPEasySetup.eps}
%   \caption{Setup?\label{fig:HPEasySetup}}
%   \end{center}
% \end{figure}

% \begin{figure}[ht]
%   \begin{center}
%     \includegraphics[scale=0.29]{Images/HPUseBefore.eps}
%   \caption{Used Before?\label{fig:HPUseBefore}}
%   \end{center}
% \end{figure}

% \begin{figure}[ht]
%   \begin{center}
%     \includegraphics[scale=0.29]{Images/HPUseAgain.eps}
%   \caption{Use Again?\label{fig:HPUseAgain}}
%   \end{center}
% \end{figure}

% \begin{figure}[ht]
%   \begin{center}
%     \includegraphics[scale=0.29]{Images/HPHardwareVirtual.eps}
%   \caption{Hardware or Virtual?\label{fig:HPHardwareVirtual}}
%   \end{center}
% \end{figure}
