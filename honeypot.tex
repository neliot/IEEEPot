...
\textit{H}igh-\textit{I}nteraction-\textit{L}ow-\textit{V}olume (\texttt{HILV}) and 
\textit{L}ow-\textit{I}nteraction-\textit{H}igh-\textit{V}olume (\texttt{LIHV}).
...
architecture~(Fig.~\ref{fig:Overview1}). 
...
internet facilities is shown in Fig.~\ref{fig:NetworkLogical}.
