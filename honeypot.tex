...
\begin{abstract}
  In the teaching of cybersecurity, students benefit greatly from having full control of physical equipment and services. However, this presents far too great a risk to the security of a university campus network.
  This paper describes an approach that has been used successfully at Northumbria University in which students have access to an off-campus network of laboratory machines with a dedicated connection to the Internet.
